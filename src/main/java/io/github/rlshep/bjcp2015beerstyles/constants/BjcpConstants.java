...
public class BjcpConstants {
    ...
    public static final int DATABASE_VERSION = 20;   // Make sure LoadBjcp project picks up this change for PRAGMA header
    ...
    public static final String BJCP_2021 = "BJCP_2015";
